                ...
                <div class="containerf">
                    ...
                    <div class="containerh">
                        <div class="containerhe">
                            ...
                            <h2 style="float left"> NON ACADEMIC STAFFINBOX </h2>
                                            ...
                                            <div class="modal-body">
                                                <form action="addstudent.jsp" method="post" name="f1">
                                                    <center>
                                                        ...
                                                        <input type="text" placeholder="photos" name="photos"><br><br>
                                                        <input type="number" placeholder="documentss" name="documents"><br><br>
                                                        <input type="submit">
                                                    </center>
                                                </form>
                                            </div>
